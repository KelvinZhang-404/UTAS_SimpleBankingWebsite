        ...
        <form action="transaction_process.php" method="post">
            <table>
                ...
                <tr>
                    <td></td>
                    <td>
                        <input type="number" name="client_number" placeholder="Client Number" required>
                    </td>
                </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    <td></td>
                    <td><input type="submit" value="Confirm" name="confirm_intra"></td>
                </tr>
            </table>
